          ...
          <>
            <div className='mb-10'>
              <div className=' text-black text-opacity-50 gap-1 my-[23px] text-[14px] flex'>
                ...
                <Link to="/">Home</Link>/<Link className='text-[#E50914]' to="/firenews">Fire news</Link>
              </div>
              <div className='w-full border-b border-[#E50914]'>
                <p className='text-[#E50914]  flex items-center text-[24px] font-semibold  pb-[10px] gap-2'>Fire news <AiFillFire /></p>
              </div>
            </div>
