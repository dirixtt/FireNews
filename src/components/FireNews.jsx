...
export default function FireNews({ data }) {
  return (
          ...
          <>
            <div className='mb-10'>
              <div className=' text-black text-opacity-50 gap-1 my-[23px] text-[14px] flex'>
                ...
                <Link  to="/">Uy</Link>/<Link className='text-[#E50914]' to="/firenews">Olovli yangiliklar</Link>
              </div>
              <div className='w-full border-b border-[#E50914]'>
                <p className='text-[#E50914]  flex items-center text-[24px] font-semibold  pb-[10px] gap-2'>Olovli yangiliklar <AiFillFire/></p>
              </div>
            </div>
            <div className='flex justify-between'>
              <div className='relative w-[49.5%] h-[250px] rounded '>
                ...
                <div className='absolute items-center px-4 top-[20px] rounded-b flex justify-between w-full text-[14px]'>
                  ...
                  <p className='p-2 rounded text-lg text-white bg-[#E50914] flex justify-center items-center'><AiFillFire /></p>
                </div>
              </div>
              <div className='relative w-[49.5%] h-[250px] rounded '>
