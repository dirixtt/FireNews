                    ...
                    <>
                        <div className='mb-10'>
                            <div className=' text-black text-opacity-50 gap-1 my-[23px] text-[14px] flex'>
                                ...
                                <Link to="/">Home</Link>/<Link className='text-[#E50914]' to="/worldnews">business</Link>
                            </div>
                            <div className='w-full border-b border-[#E50914]'>
                                <p className='text-[#E50914]  flex items-center text-[24px] font-semibold  pb-[10px] gap-2'>Business</p>
                            </div>
                        </div>
                        <div className='flex justify-between'>
                            <div className='relative  w-full xl:w-[49.5%] h-auto xl:h-[400px] rounded '>
                                <img className='object-cover w-full rounded h-[400px]' src={business[2].urlToImage} alt="" />
                                <div className='absolute text-[14px] md:text-[18px] p-[8px] bg-black bg-opacity-50 w-full text-white h-[30%] bottom-0 '>
                                    <Link className='hover:text-[#E50914]' to={`/products/${business[2].publishedAt}`}>
                                        {business[2].title}
                                    </Link >
                                ...
                                <div className='absolute items-center px-4 top-[20px] rounded-b flex justify-between w-full text-[14px]'>
                                    <p className=' p-1 text-white bg-[#E50914] left-2'>{business[2].category}</p>
                            ...
                            <div className='relative hidden xl:flex w-[49.5%] h-[400px] rounded '>
                                <div>
                                    ...
                                    <img className='object-fill w-full rounded min-h-[400px]' src={business[0].urlToImage} alt="" />
                                </div>
                                <div className='absolute text-[18px] p-[8px] bg-black bg-opacity-50 w-full text-white h-[30%] bottom-0 '>
                                    <Link className='hover:text-[#E50914]' to={`/products/${business[0].publishedAt}`}>
                                        {business[0].title}
                                    </Link >
                                    <div className='text-[14px] gap-3 flex mt-3'>
                                        <p className='flex items-center gap-2'>
                                            ...
                                            {dayjs(business[0].publishedAt).format("DD MMM, YYYY")}
                                        </p>
                                        |
                                        <p className="flex gap-2 ">
                                ...
                                <div className='absolute items-center px-4 top-[20px] rounded-b flex justify-between w-full text-[14px]'>
                                    <p className=' p-1 text-white bg-[#E50914] left-2'>{business[0].category}</p>
                                    <p className='p-2 rounded text-lg text-white bg-[#E50914] flex justify-center items-center'><BsFillLightningFill /></p>
                                </div>
                            </div>
                        </div>
                            ...
                            {business?.map((item, idx) => (
                                <div key={idx} className='w-full xl:w-[49%] flex mt-[20px] h-[130px]'>
                                    ...
                                    <div className='ml-3 pb-0 flex justify-between flex-col items-start text-[18px] font-semibold'>
                                        <Link className='hover:text-[#E50914] xl:text-xl text-sm' to={`/products/${item.id}`}>
                                            <h2>{item.title}</h2>
                                        </Link>
